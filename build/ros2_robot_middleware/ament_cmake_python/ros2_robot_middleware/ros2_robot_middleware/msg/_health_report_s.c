...
bool ros2_robot_middleware__msg__health_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_robot_middleware.msg._health_report.HealthReport", full_classname_dest, 53) == 0);
  }
  ros2_robot_middleware__msg__HealthReport * ros_message = _ros_message;
  {  // header
  ...
  {  // nodes
    ...
    if (!ros2_robot_middleware__msg__HealthStatus__Sequence__init(&(ros_message->nodes), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ros2_robot_middleware__msg__HealthStatus__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ros2_robot_middleware__msg__HealthStatus * dest = ros_message->nodes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ros2_robot_middleware__msg__health_status__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * ros2_robot_middleware__msg__health_report__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_robot_middleware.msg._health_report");
  ...
  {  // nodes
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ros2_robot_middleware__msg__health_status__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
