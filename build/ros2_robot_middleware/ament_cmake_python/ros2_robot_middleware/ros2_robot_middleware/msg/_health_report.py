    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros2_robot_middleware.msg.HealthReport')
            logger.debug(
            ...
            from ros2_robot_middleware.msg import HealthStatus
            if HealthStatus.__class__._TYPE_SUPPORT is None:
                HealthStatus.__class__.__import_type_support__()
...
class HealthReport(metaclass=Metaclass_HealthReport):
    ...
    _fields_and_field_types = {
        ...
        'nodes': 'sequence<ros2_robot_middleware/HealthStatus>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros2_robot_middleware', 'msg'], 'HealthStatus')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, HealthStatus) for v in value) and
                 True), \
                "The 'nodes' field must be a set or sequence and each value of type 'HealthStatus'"
        self._nodes = value
