...
#include "ros2_robot_middleware/msg/detail/object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_robot_middleware::msg::Object & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_robot_middleware::msg::Object & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_robot_middleware::msg::Object;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ros2_robot_middleware::msg::Object *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_robot_middleware::msg::Object *>(
    untyped_ros_message);
...
{
  return &ros2_robot_middleware::msg::typesupport_fastrtps_cpp::_Object__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_robot_middleware, msg, Object)() {
  return &ros2_robot_middleware::msg::typesupport_fastrtps_cpp::_Object__handle;
}
