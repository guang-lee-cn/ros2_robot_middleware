...
{
  new (message_memory) ros2_robot_middleware::msg::Object(_init);
}

void Object_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_robot_middleware::msg::Object *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Object_message_member_array[4] = {
  {
    ...
    offsetof(ros2_robot_middleware::msg::Object, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_robot_middleware::msg::Object, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_robot_middleware::msg::Object, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_robot_middleware::msg::Object, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Object_message_members = {
  ...
  "Object",  // message name
  4,  // number of fields
  sizeof(ros2_robot_middleware::msg::Object),
...
get_message_type_support_handle<ros2_robot_middleware::msg::Object>()
{
  return &::ros2_robot_middleware::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_robot_middleware, msg, Object)() {
  return &::ros2_robot_middleware::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
