...
class SetParam_Event(metaclass=Metaclass_SetParam_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros2_robot_middleware/SetParam_Request, 1>',
        'response': 'sequence<ros2_robot_middleware/SetParam_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_robot_middleware', 'srv'], 'SetParam_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_robot_middleware', 'srv'], 'SetParam_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros2_robot_middleware.srv import SetParam_Request
    ...
    def response(self, value):
        if self._check_fields:
            from ros2_robot_middleware.srv import SetParam_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SetParam(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_robot_middleware.srv.SetParam')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_robot_middleware.srv import _set_param
...
class SetParam(metaclass=Metaclass_SetParam):
    from ros2_robot_middleware.srv._set_param import SetParam_Request as Request
    from ros2_robot_middleware.srv._set_param import SetParam_Response as Response
    from ros2_robot_middleware.srv._set_param import SetParam_Event as Event
